...
def preprocess_df(df,text_column='text',target_column='target'):
    """
    Preprocesses the DataFrame by encoding the target column and transforming the text column
    """
    try:
        logger.debug('Starting preprocesssing for DataFrame')
...
def main(text_column='text',target_column='target'):
    """
    Main function to load the data , preprocess it , and save the preprocess it.
    """
    try:
